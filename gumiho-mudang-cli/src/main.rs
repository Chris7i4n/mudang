//! mudang — code intelligence CLI for LLM coding agents.
//!
...
use gumiho_mudang_scope::config;
...
#[command(
    ...
    long_about = "mudang builds a local code intelligence index and lets you query \
                  it efficiently. Use it before editing any non-trivial code to \
                  understand structure, dependencies, and blast radius.",
    version,
