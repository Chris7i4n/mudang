...
- 2026-05-14 | sprint 0005 | merged | commit `45cf68a` | notes: FF merge to `main` complete; branch `selfcorrect/sprint-0005-labeller-workspace-scaffolding` deleted locally (no remote branch existed) per single-operator hygiene
