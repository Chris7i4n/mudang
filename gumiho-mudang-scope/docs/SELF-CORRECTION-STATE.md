...
| Priority 1 (b₁) — Labeller workspace scaffolding + shared core | 0005 | unstarted | — | — | sibling workspace `gumiho-mudang-labeller/`, excluded from root; ships `scope-audit-labeller-core` + `-noop` reference impl |
...
| 0005 — labeller workspace scaffolding + core | unstarted | — | — |
